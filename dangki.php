...
if (isset($_POST['dangki'])){
    ...
    {
        $dangki = $c_user->dangkyTaiKhoan($name,$mail,$password);
    }
    if (isset($_POST['dangki']))
    {
        $email = $_POST['email'];
        $password = $_POST['password'];
        $user = $c_user->dangnhapTaiKhoan($email,md5($password));
    }
}
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <form class="navbar-form navbar-left" role="search">
                ...
                <button type="submit" name="dangki" class="btn btn-default">Submit</button>
            </form>
