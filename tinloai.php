...
$tintuc = new C_tintuc();
$loaitins = $tintuc->loaitin();
$tintuc = $loaitins['danhmuctin'];
$menu = $loaitins['menu'];
$title = $loaitins['ten'];
$thanh_phantrang= $loaitins['thanh_phantrang'];
$alias = $loaitins ['alias'];
//print_r($alias);
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <ul>
                        ...
                        foreach ($loaitin as $loai) {
                            ...
                            <li class="list-group-item">
                                <a href="tinloai.php?id_loai=<?=$id?>"><?=$ten?></a>
                            </li>
                            <?php
                        }
                        ?>
